...
const _routes = [
  {
    name: "id",
    path: "/:id()",
    component: () => import("./_nuxt/_id_-BAB3vPh5.js").then((m) => m.default || m)
  },
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/index-CsxmOCav.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BYp1ybsO.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-Bgp0vdR5.js").then((m) => m.default || m)
};
